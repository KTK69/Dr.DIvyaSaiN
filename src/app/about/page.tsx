      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-padding">
        ...
        <section className="mb-20" aria-labelledby="philosophy-heading">
          ...
          <div className="glass-card rounded-2xl p-10 relative">
            <Quote
              size={40}
              className="text-(--accent-gold) opacity-20 mb-4"
            />
            <blockquote>
              <p
            ...
            {education.map((edu) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {edu.note && (
                    <p className="text-xs text-(--accent-gold-light) mt-1">
                      {edu.note}
                    </p>
                  )}
                </div>
                <div className="shrink-0">
                  <span className="text-xs text-(--foreground-subtle) px-3 py-1 rounded-full border border-(--border)">
                    {edu.period}
                  </span>
                </div>
              </div>
        ...
        <section className="mb-20" aria-labelledby="awards-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {awards.map((award) => (
              ...
              >
                <p
                  className="text-2xl font-medium text-(--accent-gold-light) mb-2"
                  style={{ fontFamily: "var(--font-serif)" }}
                >
                  {award.year}
                </p>
        ...
        <div className="text-center pt-6 border-t border-(--border)">
          ...
          <Link
            href="/experience"
            className="inline-flex items-center gap-2 text-sm text-(--accent-gold-light) hover:underline"
          >
